...
public class FirstTest extends CoreTestCase {
    ...
    @Test
    public void testCheckInputContainsText()
    {
    ...
    @Test
    public void testCheckRequestTextAtResults()
    {
        String request = "Java";
    ...
    public void testSaveArticlesToMyList()
    {
        ...
        MainPageObject.addArticleToReadingList(first_article_title);
        ...
        MainPageObject.addArticleToReadingList(second_article_title);
